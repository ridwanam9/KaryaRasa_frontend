...
const Navbar = () => {
  ...
  const handleLogout = async () => {
    ...
    try {
      await fetch(
        "https://dying-helli-ridwanam9-4b98d171.koyeb.app/users/logout",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  href={{
                    pathname: "/product/product-list",
                    query: { category: "Art&Collectibles" },
                  }}
                >
                  Art & Collectibles
                </Link>
              ...
              <li>
                <Link
                  href={{
                    pathname: "/product/product-list",
                    query: { category: "Craft-Suplies&Tools" },
                  }}
                >
